  ...
  return (
    <div className="contener">
      ...
      <div className="left-side">
        ...
        <h1>LogIn</h1>
          {/* input email */}
          <div className="form-control" style={{backgroundColor:'transparent', border :'none' ,padding:'0'} }>
            ...
            {errors.email && errors.email.type === "required" && (
              <span style={{ color: "red" ,marginTop:"10px"}}>This is required</span>
            )}
          ...
          <FormControl
            ...
            {errors.password && errors.password.type === "maxLength" && (
              <span style={{ color: "red" , marginTop:"10px" }}>Max length exceeded</span>
            )}
            {errors.password && errors.password.type === "minLength" && (
              <span style={{ color: "red" , marginTop:"10px" }}>Min length 8 Character</span>
            )}
